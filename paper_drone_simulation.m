...
CoM.x = sum(Res.Position(:, ((1:k)*3-2)), 2) / k;
CoM.y = sum(Res.Position(:, ((1:k)*3-1)), 2) / k;
CoM.z = sum(Res.Position(:, ((1:k)*3-0)), 2) / k;
...
xlabel_handle = xlabel('$$t$$ (s)');
xlabel_handle.Interpreter = 'latex';
ylabel_handle = ylabel('$$z_{CoM}$$ (m)');
ylabel_handle.Interpreter = 'latex';
legend_handle = legend('$$z_{CoM}$$');
legend_handle.Interpreter = 'latex';
...
% ylabel_handle = ylabel('$$r_i$$ (m)');
% ylabel_handle.Interpreter = 'latex';
% legend_handle = legend('$$x_1$$', '$$y_1$$', '$$z_1$$', ...
%                        '$$x_2$$', '$$y_2$$', '$$z_2$$', ...
%                        '$$x_2$$', '$$y_2$$', '$$z_2$$');
% legend_handle.Interpreter = 'latex';
